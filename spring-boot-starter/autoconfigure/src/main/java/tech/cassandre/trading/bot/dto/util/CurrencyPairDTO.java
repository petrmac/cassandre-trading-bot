...
public class CurrencyPairDTO implements tech.cassandre.trading.bot.dto.util.CurrencyPair {
     ...
     */
    CurrencyPairDTO(final String currencyPair) {
     ...
     * @param currencyPair currency pair
     */
    CurrencyPairDTO(final CurrencyPair currencyPair) {
     ...
     */
    CurrencyPairDTO(final String newBaseCurrency, final String newQuoteCurrency) {
     ...
     * @param newQuoteCurrency The quote currency
     */
    CurrencyPairDTO(final CurrencyDTO newBaseCurrency, final CurrencyDTO newQuoteCurrency) {
     ...
     * @param newQuoteCurrency The quote currency
     */
    CurrencyPairDTO(final Currency newBaseCurrency, final Currency newQuoteCurrency) {
        this.baseCurrency = newBaseCurrency;
        this.quoteCurrency = newQuoteCurrency;
    }
     ...
     */
    CurrencyPairDTO(final Instrument instrument) {
